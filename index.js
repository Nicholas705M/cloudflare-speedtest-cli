...
async function main() {
  ...
  const options = {
    noDownload: argv["no-download"] || false,
    noUpload: argv["no-upload"] || false,
    noLatency: argv["no-latency"] || false,
    noPacketLoss: argv["no-packet-loss"] || false,
    noServerInfo: argv["no-server-info"] || false,
